...
#
# Some minor modifications made by
#   Edd Dumbill   <edd@usefulinc.com>
#   Josh Lucas    <josh@stonecottage.com>
#
# $Id: ircbot.py,v 1.4 2002/08/01 14:48:54 edmundd Exp $
...
class SingleServerIRCBot(SimpleIRCClient):
    ...
    """
    def __init__(self, server_list, nickname, realname, fn_to_add_socket, fn_to_remove_socket,
 				fn_to_add_timeout, password=None, reconnection_interval=60):
        ...
        Arguments:
            ...
            password -- Password necessary for auth

            reconnection_interval -- How long the bot should wait
                                     before trying to reconnect.
        """

        SimpleIRCClient.__init__(self, fn_to_add_socket, fn_to_remove_socket, fn_to_add_timeout)
    ...
    def _connect(self):
        ...
        if len(self.server_list[0]) > 2:
            self._password = self.server_list[0][2]
        try:
