...
#
# $Id: irclib.py,v 1.1 2001/03/15 22:58:25 mattb Exp $
...
class SimpleIRCClient:
    ...
    """
    def __init__(self, fn_to_add_socket, fn_to_remove_socket, fn_to_add_timeout):
        self.ircobj = IRC(fn_to_add_socket, fn_to_remove_socket, fn_to_add_timeout)
